...
window.onload = function () {
  if (window.location.href.indexOf("hk") > -1) {
    ...
    } else if (location.pathname == "/hk/lp02/" || location.pathname == "/hk/lp03/" ) {
      rightContents1.innerHTML =
        '<span style="line-height: 30px;">實際費用將以港幣兌換新台幣之交易匯率為準<br>\n\
        ①　一件 1200元<br>\n\
        ②　二件 2280元<br>\n\
    ...
    }else if (location.pathname == "/hk/double11_2019/") {
      rightContents1.innerHTML =
        '<span style="line-height: 30px;">實際費用將以港幣兌換新台幣之交易匯率為準<br>\n\
        ①　一件 1200元<br>\n\
        ②　二件 2280元<br>\n\
...
function GetJsonData() {
  ...
  rawFile.open("GET", 'https://www.co-medical.tw/CommonFilesCrossing_TW2HK/js/lock.json', false);
